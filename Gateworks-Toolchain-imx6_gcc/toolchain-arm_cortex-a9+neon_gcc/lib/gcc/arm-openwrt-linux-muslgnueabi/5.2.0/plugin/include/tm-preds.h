/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/usr/src/buildbot/gateworks-bb-slave/gateworks-bb-slave/Builder_openwrt-16_02/build/build_dir/toolchain-arm_cortex-a9+neon_gcc-5.2.0_musl-1.1.12_eabi/gcc-5.2.0/gcc/config/arm/arm.md'.  */
